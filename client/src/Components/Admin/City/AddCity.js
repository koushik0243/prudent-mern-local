...
const AddCity = () => {
    ...
    const { loading } = useAppSelector((state) => state.cityMaster);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.error(err || 'Failed to create city');
        }
    };
    ...
    return (
        <div className="show-contact-container">
            <div className="show-contact-header">
                ...
                <div>
                    <h1 className="page-title">Add New City</h1>
                    <p className="page-subtitle">Create a new city entry</p>
                </div>
            </div>
